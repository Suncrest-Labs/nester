...
export function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t border-border bg-white/90 dark:bg-[#0A0A0A]/90 backdrop-blur-md pb-safe pt-2 px-2 md:hidden">
            {BOTTOM_NAV.map((item) => {

...
export function SkeletonStatCard() {
  return (
    <div className="rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-white dark:bg-[#100F0F] p-6 space-y-3">
...
export function SkeletonActivityItem() {
  return (
    <div className="flex items-center justify-between rounded-xl bg-black/[0.015] dark:bg-white/[0.015] px-5 py-3.5">
